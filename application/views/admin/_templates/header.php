...
<?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/liteadmin/css/liteadmin.min.css'); ?>">
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/liteadmin/css/skins/skin-blue.min.css'); ?>">
...
<?php endif; ?>
        <link rel="stylesheet" href="<?php echo base_url($frameworks_dir . '/projects/css/dp.min.css'); ?>">
<?php if ($mobile === FALSE): ?>
        <!--[if lt IE 9]>
