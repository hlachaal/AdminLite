...
<?php endif; ?>
        <script src="<?php echo base_url($frameworks_dir . '/liteadmin/js/liteadmin.min.js'); ?>"></script>
        <script src="<?php echo base_url($frameworks_dir . '/projects/js/dp.min.js'); ?>"></script>
    </body>
</html>