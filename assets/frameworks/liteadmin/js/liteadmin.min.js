/*! LiteAdmin app.js
 * ================
 * Main JS application file for LiteAdmin v2. This file
 * should be included in all pages. It controls some layout
 * options and implements exclusive LiteAdmin plugins.
 *
  ...
  ($.LiteAdmin.layout = {
    ...
    fix: function() {
      ...
      if ($("body").hasClass("fixed"))
        ...
        var f = $($.LiteAdmin.options.controlSidebarOptions.selector);
        "undefined" != typeof f &&
          f.height() > e &&
    ...
    fixSidebar: function() {
      return $("body").hasClass("fixed")
        ? ("undefined" == typeof $.fn.slimScroll &&
          ...
          void (
            $.LiteAdmin.options.sidebarSlimScroll &&
            "undefined" != typeof $.fn.slimScroll &&
            ($(".sidebar")
    ...
    ($.LiteAdmin.pushMenu = {
      activate: function(a) {
        var b = $.LiteAdmin.options.screenSizes;
        $(document).on("click", a, function(a) {
          ...
          ($.LiteAdmin.options.sidebarExpandOnHover ||
            ($("body").hasClass("fixed") &&
      ...
      expandOnHover: function() {
        var a = this,
          b = $.LiteAdmin.options.screenSizes.sm - 1;
        $(".main-sidebar").hover(
          function() {
            $("body").hasClass("sidebar-mini") &&
              $("body").hasClass("sidebar-collapse") &&
    ...
    ($.LiteAdmin.tree = function(a) {
      var b = this,
        c = $.LiteAdmin.options.animationSpeed;
      $(document)
        .off("click", a + " li a")
    ...
    ($.LiteAdmin.controlSidebar = {
      activate: function() {
        var a = this,
          b = $.LiteAdmin.options.controlSidebarOptions,
          c = $(b.selector),
    ...
    ($.LiteAdmin.boxWidget = {
      selectors: $.LiteAdmin.options.boxWidgetOptions.boxWidgetSelectors,
      icons: $.LiteAdmin.options.boxWidgetOptions.boxWidgetIcons,
      animationSpeed: $.LiteAdmin.options.animationSpeed,
      activate: function(a) {
        var b = this;
        a || (a = document),
...
if ("undefined" == typeof jQuery) throw new Error("LiteAdmin requires jQuery");
($.LiteAdmin = {}),
  ($.LiteAdmin.options = {
  ...
  $(function() {
    ...
    $("body").removeClass("hold-transition"),
      "undefined" != typeof LiteAdminOptions &&
        $.extend(!0, $.LiteAdmin.options, LiteAdminOptions);
    var a = $.LiteAdmin.options;
    _init(),
      $.LiteAdmin.layout.activate(),
      a.enableControlTreeView && $.LiteAdmin.tree(".sidebar"),
      a.enableControlSidebar && $.LiteAdmin.controlSidebar.activate(),
      a.navbarMenuSlimscroll &&
        ...
        $(".navbar .menu")
          ...
          .css("width", "100%"),
      a.sidebarPushMenu &&
        $.LiteAdmin.pushMenu.activate(a.sidebarToggleSelector),
      a.enableBSToppltip &&
        $("body").tooltip({ selector: a.BSTooltipSelector, container: "body" }),
      a.enableBoxWidget && $.LiteAdmin.boxWidget.activate(),
      a.enableFastclick &&
  ...
  (function(a) {
    ...
    (a.fn.activateBox = function() {
      a.LiteAdmin.boxWidget.activate(this);
    }),
      (a.fn.toggleBox = function() {
        var b = a(a.LiteAdmin.boxWidget.selectors.collapse, this);
        a.LiteAdmin.boxWidget.collapse(b);
      }),
      (a.fn.removeBox = function() {
        var b = a(a.LiteAdmin.boxWidget.selectors.remove, this);
        a.LiteAdmin.boxWidget.remove(b);
      });
  })(jQuery),
  (function(a) {
    "use strict";
